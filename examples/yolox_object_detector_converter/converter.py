...
def preprocessing(frame: Frame, config:dict):
    """
...
def write_artifacts(prefix: str):
    ...
    # ------------- END OF SERIALIZING PREPROCESSING FUNCTION -------

    # -------------- SERIALIZE THE POSTPROCESSING FUNCTION -----------
    with open(prefix + '.postprocess', 'wb') as fid:
        dill.dump(postprocessing, fid)
    # ------------- END OF SERIALIZING POSTPROCESSING FUNCTION -------
